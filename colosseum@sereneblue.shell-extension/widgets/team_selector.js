...
export const TeamSelectorDialog = GObject.registerClass(class TeamSelectorDialog extends ModalDialog.ModalDialog {
                ...
                teamSwitch.connect('clicked', () => {
                    ...
                    if (index >= 0) {
                        ...
                        try {
                            ...
                            logErr(e, 'Failed to reset style for teamLabel');
                        }
                        try {
                            teamBox.remove_style_class_name('team--followed');
                        }
                        catch (e) {
                            logErr(e, 'Failed to remove style class from teamBox');
                        }
                    }
                    else {
